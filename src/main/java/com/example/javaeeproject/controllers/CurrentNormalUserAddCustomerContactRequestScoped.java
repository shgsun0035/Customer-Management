...
@RequestScoped
@Named("currentNormalUserCustomerContact")
public class CurrentNormalUserAddCustomerContactRequestScoped {
	...
	public CurrentNormalUserAddCustomerContactRequestScoped() {
